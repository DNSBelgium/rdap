...
public final class Domain extends Common {
  ...
  public static class Builder {
    ...
    public Builder addStatus(Status status) {
      if (this.status == null) this.status = new ArrayList<Status>();
    ...
    public Builder addRemark(Notice n) {
      if (remarks == null) remarks = new ArrayList<Notice>();
      this.remarks.add(n);
      return this;
    }
    ...
    public Builder addDelegationKey(DelegationKey delegationKey) {
      if (delegationKeys == null) delegationKeys = new ArrayList<DelegationKey>();
      this.delegationKeys.add(delegationKey);
      return this;
    }

    public Builder addNameserver(Nameserver ns) {
      if (nameservers == null) nameservers = new ArrayList<Nameserver>();
      nameservers.add(ns);
      return this;
    }
  }
