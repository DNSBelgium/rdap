...
public final class Link {
  ...
  public Link(
    ...
    if (value == null) throw new NullPointerException("value MUST be specified");
    if (rel == null) throw new NullPointerException("rel MUST be specified");
    if (href == null) throw new NullPointerException("href MUST be specified");
  ...
  public static class Builder {
    ...
    public Builder addHreflang(String hreflang) {
      if (this.hreflang == null) this.hreflang = new HashSet<String>();
      this.hreflang.add(hreflang);
      return this;
    }

    public Builder addTitle(String title) {
      if (this.title == null) this.title = new ArrayList<String>();
